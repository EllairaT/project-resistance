...
//            var testCM = new CardMaster();
//            var currentCard = new CurrentCard();
...
//            currentCard.cardSystem = cs;
//            currentCard.card = testCard;  
//            cs.numberToSpawn = 5;
            
//            var expected = 1000 - (100 * 5);
//            currentCard.TestCardCost(cs, cs.numberToSpawn);
//            cs.testBuy(testCM.gold);

//            Assert.AreEqual(cs.testBuy(testCM.gold), expected);
//            yield return null;
//        }

//        [UnityTest]
//        public IEnumerator SpectatorCamTest()
//        {
//            var gs = new InGameScript();
//            gs.spectatorCamera = new GameObject();
//            gs.TestHealthBar();

//            Assert.IsTrue(gs.spectatorCamera.activeSelf);
//            yield return null;
//        }

//        [UnityTest]
//        public IEnumerator CardMasterCamTest()
//        {
//            var gameObj = new GameObject();
//            gameObj.AddComponent<Camera>();
//            var mouse = gameObj.AddComponent<CMCamera>();

//            Assert.AreEqual(-20, mouse.TestLookX(1, 20, 1));
